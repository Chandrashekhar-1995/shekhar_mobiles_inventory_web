...
import RequiredFields from "../user/customer/RequiredFields";
import OptionalFields from "../user/customer/OptionalFields";
import MoreDetails from "../user/userComponent/MoreDetails";
import TrueFalseOption from "../user/userComponent/TrueFalseOption";
        ...
        <div className="flex items-center justify-center mb-8 pt-4 m-2 bg-gray-100 border border-black ">
          <div className="bg-white mb-8 rounded-lg shadow-md w-[80%] max-w-4xl pt-0 p-6 overflow-y-auto ">
            <div className="flex items-center justify-between">
              <h2 className="font-semibold mb-4 text-sm">Supplier details</h2>
